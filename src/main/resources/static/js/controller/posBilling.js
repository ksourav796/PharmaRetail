app.controller('posBillingCtrl',
    function ($scope, $location, $rootScope, $http, $interval, Notification, $timeout, $window, $filter, keyboardManager2) {
        ...
        $scope.getPageLoadData=function(){
            $http.post('/pos' + '/getFormSetup?type='+'DirectSalesInvoice').then(function (response) {
        ...
        $scope.editInvoiceList = function (val) {
            ...
            $http.post('/sales'+ '/getSalesInvoicesList?status=' + "Prepared"+ "&search=" + val).then(function (response) {
                var data = response.data;
        ...
        $scope.editDraftInvoiceList = function (val) {
            ...
            $http.post('/sales'+ '/getSalesInvoicesList?status=' + "Draft"+ "&search=" + val).then(function (response) {
                var data = response.data;
                $scope.posSalesList = angular.copy(data);
        ...
        $scope.editInvoiceListReturn = function (val,val1) {
            ...
            $http.post('/sales'+ '/getSalesInvoicesList?status=' + val + "&search=" + val1).then(function (response) {
                var data = response.data;
                $scope.posSalesList = angular.copy(data);
